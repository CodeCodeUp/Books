    ...
    >
      ...
      <g transform="translate(2,2)">
        ...
        <g transform="translate(13.75,9.25)" class="loader__model">
          <!-- 玻璃外壳 -->
          <path
            d="M 1.5 2 L 23 2 C 23 2 22.5 8.5 19 12 C 16 15.5 13.5 13.5 13.5 16.75 C 13.5 20 16 18 19 21.5 C 22.5 25 23 31.5 23 31.5 L 1.5 31.5 C 1.5 31.5 2 8.5 5.5 12 C 8.5 15.5 11 13.5 11 16.75 C 11 20 8.5 18 5.5 21.5 C 2 25 1.5 31.5 1.5 31.5 Z"
            fill="rgba(255, 255, 255, 0.9)"
          ></path>

          <!-- 沙子动画 -->
          <g stroke-linecap="round" stroke="#5ac8fa">
            <line
              y2="20.75"
              x2="12"
              y1="15.75"
          ...
          <!-- 玻璃高光 -->
          <g stroke-width="2" stroke-linecap="round" opacity="0.6" fill="none">
            <path
          ...
          <!-- 上下边框 -->
          <rect height="2" width="24.5" fill="#007aff"></rect>
          <rect
            height="1"
            width="19.5"
            y="0.5"
